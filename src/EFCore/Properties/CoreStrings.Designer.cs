...
namespace Microsoft.EntityFrameworkCore.Diagnostics
{
    ...
    public static class CoreStrings
    {
        ...
        /// <summary>
        ///     Translation of member '{member}' on type '{instanceType}' failed. Either source is not an entity type or the specified property does not exist on the entity type.
        /// </summary>
        public static string QueryUnableToTranslateMember([CanBeNull] object member, [CanBeNull] object instanceType)
            => string.Format(
                GetString("QueryUnableToTranslateMember", nameof(member), nameof(instanceType)),
                member, instanceType);
